...
public class SudokuBoard {
  ...
  private List<SudokuMatrixRow> sudokuMatrixRow;
  ...
  public List<SudokuMatrixRow> getSudokuMatrixRow() {
	return sudokuMatrixRow;
}

public void setSudokuMatrixRow(List<SudokuMatrixRow> sudokuMatrixRow) {
